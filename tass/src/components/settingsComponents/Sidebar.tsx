  ...
  return (
    <aside className="w-full md:w-56 h-[556px] border border-gray-200 rounded-xl px-4 py-5 flex flex-col gap-6 shrink-0 sticky top-8">
      ...
      <div>
        ...
        <button
          className={`flex items-center gap-2 px-3 py-2.5 rounded-lg text-sm font-semibold cursor-pointer transition-all duration-200 w-full text-left group hover:shadow-sm ${activeTab === 'profile'
        ...
        >
          <User
            size={18}
            className={`transition-colors duration-200 flex-shrink-0 ${activeTab === 'profile'
                ? 'text-orange-500'
      ...
      <div>
        ...
        <button
          className={`flex items-center gap-2 px-3 py-2.5 rounded-lg text-sm font-semibold cursor-pointer transition-all duration-200 w-full text-left group hover:shadow-sm ${activeTab === 'userManagement'
              ? 'bg-orange-50 border border-orange-200 text-orange-700 shadow-md'
              : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900 border border-transparent'
            }`}
        ...
        >
          <Users
            size={18}
            className={`transition-colors duration-200 flex-shrink-0 ${activeTab === 'userManagement'
                ? 'text-orange-500'
                : 'text-gray-500 group-hover:text-gray-600'
              }`}
          />
