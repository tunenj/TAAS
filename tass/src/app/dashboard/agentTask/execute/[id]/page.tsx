                  ...
                  <div className="flex items-center space-x-4">
                    <div className="flex flex-col items-start">
                      ...
                      <div className="flex gap-2">
                        <button
                          className={`px-2 py-0.5 rounded-full text-xs mr-1 border ${step.access === true ? 'bg-green-100 border-green-300 text-green-700' : 'border-gray-300 text-gray-400 bg-white'}`}
                        >
                          Yes
                        </button>
                        <button
                          className={`px-2 py-0.5 rounded-full text-xs border ${step.access === false ? 'bg-red-100 border-red-300 text-red-700' : 'border-gray-300 text-gray-400 bg-white'}`}
                        >
                          No
                        </button>
                      </div>
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <div className="flex gap-2">
                        <button
                          className={`px-2 py-0.5 rounded-full text-xs mr-1 border ${step.pass === true ? 'bg-green-100 border-green-300 text-green-700' : 'border-gray-300 text-gray-400 bg-white'}`}
                        >
                          Pass
                        </button>
                        <button
                          className={`px-2 py-0.5 rounded-full text-xs border ${step.pass === false ? 'bg-red-100 border-red-300 text-red-700' : 'border-gray-300 text-gray-400 bg-white'}`}
                        >
                          Fail
                        </button>
                      </div>
          ...
          <div className="bg-white p-6 rounded shadow flex flex-col justify-between">
            <div>
              ...
              <ul className="text-xs text-gray-500 mb-2">
                <li>Run created <span className="float-right text-gray-400">10:21</span></li>
                <li>Step 2 evidence added <span className="float-right text-gray-400">10:23</span></li>
                <li>Status changed to <span className="text-gray-700">Running</span> <span className="float-right text-gray-400">10:24</span></li>
              </ul>
