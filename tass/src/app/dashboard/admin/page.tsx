...
const Dashboard: React.FC = () => {
    ...
    return (
        <main className="bg-gray-50 mt-10 min-h-screen -ml-5 px-6">
            <div className="flex justify-between items-center mb-8">
                ...
                {!loading && location && (
                    <div className="bg-white px-4 py-2 rounded-lg shadow-md shadow-orange-500 border-orange-500">
                ...
                {!loading && !location && (
                    <div className="bg-yellow-50 px-4 py-2 rounded-lg shadow-sm border border-yellow-200">
                        ...
                        {testCases.map((test, idx) => (
                            ...
                            >
                                ...
                                <div className="flex flex-col items-end w-24 sm:w-32">
                                    ...
                                    <span className="text-xs text-black mt-1">{test.timeElapsed}</span>
                                </div>
                            </div>
                        ))}
                    </div>
